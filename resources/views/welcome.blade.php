        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="d-flex align-items-center mt-4">
                    <a href="#" class="btn btn-primary me-3 btn-lg display-6">
                    ...
                    <div class="d-flex flex-row align-items-center gap-3">
                        ...
                        <div class="d-flex flex-column text-left">
                            <span class="fw-bold fs-3">927 023 710</span>
    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="p-4 bg-light rounded shadow-sm text-center">
                ...
                <div class="d-flex align-items-center justify-content-center mt-3">
                    <img src="{{asset('image/IMG-20231021-WA0017.jpg')}}" alt="Avatar" class="rounded-circle me-2" style="width: 50px; height: 50px;">
                    <div>
                        <h6 class="fw-bold mb-0" style="color: #1E5DBC;">Osvaldo Victor</h6>
                        <small class="text-muted">Lubango, Chioco</small>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="p-4 bg-light rounded shadow-sm text-center">
                ...
                <div class="d-flex align-items-center justify-content-center mt-3">
                    <img src="{{asset('image/face-2.png')}}" alt="Avatar" class="rounded-circle me-2" style="width: 50px; height: 50px;">
                    <div>
                        <h6 class="fw-bold mb-0" style="color: #1E5DBC;">Maria dos Santos</h6>
                        <small class="text-muted">Benguela, Casa Verdde</small>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="p-4 bg-light rounded shadow-sm text-center">
                ...
                <div class="d-flex align-items-center justify-content-center mt-3">
                    <img src="{{asset('image/face-1.png')}}" alt="Avatar" class="rounded-circle me-2" style="width: 50px; height: 50px;">
                    <div>
                        <h6 class="fw-bold mb-0" style="color: #1E5DBC;"> Paulo Sergio</h6>
                        <small class="text-muted">Huambo, Vila Nova</small>
                    </div>
                </div>
            </div>
        </div>
